...
$VI_VM | ForEach-Object {
    $snapshot = Get-VM $_ | Get-Snapshot | Sort-Object -Property Created -Descending | Select-Object -First 1
    Set-VM -VM $_ -SnapShot $snapshot -Confirm:$false -RunAsync | Out-Null
}
